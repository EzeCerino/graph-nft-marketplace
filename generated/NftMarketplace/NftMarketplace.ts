...
export class ItemBougth extends ethereum.Event {
  get params(): ItemBougth__Params {
    return new ItemBougth__Params(this);
  }
}

export class ItemBougth__Params {
  _event: ItemBougth;

  constructor(event: ItemBougth) {
    this._event = event;
  }
